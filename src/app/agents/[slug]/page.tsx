      ...
      <PageSection backgroundVariant="light" paddingVariant="topCompact">
        ...
        <div className="prose sm:prose-lg md:prose-xl my-12 md:my-14">
          ...
          <p>
            ...
            (Proof of Replication). Think of PDP as: upload data, it stays warm
            and provably available, you pay continuously.
          </p>
          ...
          <ul>
            <li>
              Target the latest SDK version once available; earlier versions may
